...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('chunk-__federation_shared_react.js', import.meta.url).href),import:true,requiredVersion:'18.3.1'},'react-dom':{get:()=>()=>__federation_import(new URL('chunk-__federation_shared_react-dom.js', import.meta.url).href),import:true,requiredVersion:'18.3.1'},'antd':{get:()=>()=>__federation_import(new URL('chunk-__federation_shared_antd.js', import.meta.url).href),import:true,requiredVersion:'^5.22.0'}};
