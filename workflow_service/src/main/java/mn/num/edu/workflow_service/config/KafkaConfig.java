...
public class KafkaConfig {
    ...
    private String resolveBootstrapServers() {
        String systemProperty = System.getProperty("spring.kafka.bootstrap-servers");
        if (systemProperty != null && !systemProperty.isBlank()) {
            return systemProperty;
        }

        String environmentVariable = System.getenv("SPRING_KAFKA_BOOTSTRAP_SERVERS");
    ...
    public ProducerFactory<String, Object> producerFactory() {
        String effectiveBootstrapServers = resolveBootstrapServers();
        log.info("Kafka producer bootstrap servers={}", effectiveBootstrapServers);

        Map<String, Object> config = new HashMap<>();
        config.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, effectiveBootstrapServers);
    ...
    public ConsumerFactory<String, String> consumerFactory() {
        String effectiveBootstrapServers = resolveBootstrapServers();
        log.info("Kafka consumer bootstrap servers={}", effectiveBootstrapServers);

        Map<String, Object> config = new HashMap<>();
        config.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, effectiveBootstrapServers);
