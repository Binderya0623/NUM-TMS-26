...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      "py-1.5 pl-8 pr-2 text-[11px] uppercase tracking-wider font-medium text-ink-400",
      className
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "text-ink-800",
      "focus:bg-accent-soft focus:text-ink-900",
      "data-[state=checked]:text-ink-900 data-[state=checked]:font-medium",
