...
import { getDefaultExportFromCjs } from './chunk-_commonjsHelpers.js';
...
const {useContext,useEffect} = React$6;
...
function generate(node, key, rootProps) {
  if (!rootProps) {
    return /*#__PURE__*/React$6.createElement(node.tag, _objectSpread2({
      key: key
    }, normalizeAttrs(node.attrs)), (node.children || []).map(function (child, index) {
      return generate(child, "".concat(key, "-").concat(node.tag, "-").concat(index));
    }));
  }
  return /*#__PURE__*/React$6.createElement(node.tag, _objectSpread2(_objectSpread2({
    key: key
...
var Icon = /*#__PURE__*/React$4.forwardRef(function (props, ref) {
  ...
  var _React$useContext = React$4.useContext(IconContext),
  ...
  var _normalizeTwoToneColo = normalizeTwoToneColors(twoToneColor),
    ...
    primaryColor = _normalizeTwoToneColo2[0],
    secondaryColor = _normalizeTwoToneColo2[1];
  return /*#__PURE__*/React$4.createElement("span", _extends({
    role: "img",
  ...
  }), /*#__PURE__*/React$4.createElement(IconBase, {
    icon: icon,
    primaryColor: primaryColor,
    secondaryColor: secondaryColor,
    style: svgStyle
...
var RefIcon$3 = /* @__PURE__ */ React$3.forwardRef(CalendarOutlined);
...
var RefIcon$2 = /* @__PURE__ */ React$2.forwardRef(ClockCircleOutlined);
...
export { FastColor, Icon, IconContext, RefIcon, RefIcon$2 as RefIcon$1, RefIcon$3 as RefIcon$2, RefIcon$1 as RefIcon$3, _arrayLikeToArray, _arrayWithHoles, _defineProperty, _extends, _nonIterableRest, _objectSpread2, _objectWithoutProperties, _slicedToArray, _typeof, _unsupportedIterableToArray, blue, canUseDom, classNames, contains, generate$1 as generate, getShadowRoot, gold, presetPalettes, presetPrimaryColors, removeCSS, toPropertyKey, updateCSS, warning$1 as warning, warningOnce };
